...
import { ArrowLeftIcon, StarIcon, MapIcon, QuestionMarkCircleIcon, ChevronRightIcon } from 'react-native-heroicons/outline'
    ...
    <SafeAreaView>
        <ScrollView> 
            <View className="relative">
                ...
                <TouchableOpacity onPress={navigation.goBack} className="absolute top-10 left-5 p-2 bg-gray-50 rounded-full">
                ...
                <View className="px-4 pt-4">
                    ...
                    <View className="flex-row space-x-2 my-1">
                        ...
                        <View className="flex-row items-center space-x-1">
                            ...
                            <Text className="text-xs text-gray-500 px-2">Ncardy . {address}</Text>
                        </View>  
